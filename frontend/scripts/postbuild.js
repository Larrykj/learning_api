...
const filesToClean = ['index.html', 'static', 'asset-manifest.json', 'manifest.json', 'favicon.ico'];
...
console.log('✅ Build files successfully copied to Rails public directory!');
